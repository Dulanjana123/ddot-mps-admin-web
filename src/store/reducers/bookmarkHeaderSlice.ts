...
import { bookMarkData } from "@data/layout-data/header-data";
import { BookmarkSliceType, BookmarkedDataType } from "@layout/SidebarType";
...
export const { getLinkItemsArray, handleBookmarkChange } =

...
import { MenuItem, SearchSuggestionItem } from "@layout/SidebarType";
...
import { MenuList } from "@data/layout-data/sidebar-data";
import { getLinkItemsArray } from "@store/reducers/bookmarkHeaderSlice";
